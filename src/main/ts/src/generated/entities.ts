...
export let PerfilUsuarioValues: string[] = ['FRANQUEADOR', 'FRANQUEADO'];
export type PerfilUsuario = 'FRANQUEADOR' | 'FRANQUEADO';
...
export interface Cidade extends CondicaoPagamentoFornecedor {
    codigo?: number,
    cidade?: string,
    ddd?: string,
    estado?: Estado,
