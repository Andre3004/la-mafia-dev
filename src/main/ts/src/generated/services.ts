...
import { Usuario, Ambiente, Page, Cidade, Estado, PageRequest, SortDirection, Pageable, TipoFrete, NullHandling, Venda, ContasAReceber, AmbienteImagem, Sort, Cliente, Pais, Produto, Arquivo, Mesa, PerfilUsuario, ItemCompra, ItemVenda, CondicaoPagamento, SortOrder, Franquia, Fornecedor, CondicaoPagamentoFornecedor, GrupoProduto, CondicaoPagamentoParcela, FormaPagamento, Compra, Estoque, ContasAPagar } from './entities';
...
export class ContasAPagarService {
    ...
    public recoverPaymentContaAPagar(arg0?: ContasAPagar, arg1?: Boolean): Observable<void> {
        return dwrWrapper(this.brokerConfiguration, 'contasAPagarService', 'recoverPaymentContaAPagar', arg0, arg1) as Observable<void>;
    }
